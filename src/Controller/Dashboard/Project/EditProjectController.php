...
final class EditProjectController extends AbstractController
{
    ...
    public function __invoke(int $id, Request $request, FindProjectService $finder, ProjectFactory $factory, SaveProjectService $save, BreadcrumbService $breadcrumbs): Response
    {
