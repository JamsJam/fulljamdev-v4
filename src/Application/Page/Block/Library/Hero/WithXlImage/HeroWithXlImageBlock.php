...
namespace App\Application\Page\Block\Library\Hero\WithXlImage;
...
final class HeroWithXlImageBlock implements BlockDefinitionInterface
{
    public function type(): string
    {
        return 'hero.with_xl_image';
    }

    public function label(): string
    {
        return 'Hero avec image XL';
    }
    ...
    {
        return 'Page:Block:Hero:WithXlImage';
    }
