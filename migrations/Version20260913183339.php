...
final class Version20260913183339 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("INSERT INTO content_legal_page (slug, title, content) VALUES ('mention-legal', 'Mentions légales', '<p>À rédiger.</p>'), ('politique-confidentialite', 'Politique de confidentialité', '<p>À rédiger.</p>'), ('politique-cookies', 'Politique relative aux cookies', '<p>À rédiger.</p>')");
    }
