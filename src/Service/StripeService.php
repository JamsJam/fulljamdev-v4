...
class StripeService
{
    ...
    public function createCheckoutSession(
        ...
        $successRedirect = null === $successUrl ? $this->urlGenerator->generate('app_stripe_success', [], UrlGeneratorInterface::ABSOLUTE_URL) : $successUrl;
        $cancelRedirect = null === $cancelUrl ? $this->urlGenerator->generate('app_stripe_cancel', [], UrlGeneratorInterface::ABSOLUTE_URL) : $cancelUrl;
        ...
        foreach ($products as $product) {
            ...
            if (!isset(
                ...
                throw new \InvalidArgumentException('Chaque produit doit contenir "productName", "amount", "quantity", et "type".');
            }
            // dd('test reussi');
